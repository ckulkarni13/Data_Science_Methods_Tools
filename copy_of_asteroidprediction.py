...
# Load the model
model = joblib.load('/workspaces/Data_Science_Methods_Tools/RandomForest_final.pkl')
...
st.image('/workspaces/Data_Science_Methods_Tools/asteroid_img.jpg', use_column_width=True, caption='Image of an asteroid')
